...
public final class DanmakuConfigServerManager {
    ...
    private DanmakuConfigServer server;
        ...
        private final String escapeHtml(String value) {
            return StringsKt.replace$default(StringsKt.replace$default(StringsKt.replace$default(value.replace("&", "&amp;"), "\"", "&quot;", false, 4, (Object) null), "<", "&lt;", false, 4, (Object) null), ">", "&gt;", false, 4, (Object) null);
        }
