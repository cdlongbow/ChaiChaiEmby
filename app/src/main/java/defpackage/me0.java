...
public final class me0 extends SuspendLambda implements Function2 {
    public int a;
    public final /* synthetic */ uf0 b;
    public final /* synthetic */ String c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public me0(uf0 uf0Var, String str, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new me0(this.b, this.c, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((me0) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                String str = this.c;
                this.a = 1;
                obj = kb0.m(apiService, str, null, this, 2, null);
            ...
            if (!response.isSuccessful() || response.body() == null) {
                ...
                objM8825constructorimpl = Result.m8825constructorimpl(ResultKt.createFailure(new Exception("获取媒体库失败: " + response.message())));
            } else {
