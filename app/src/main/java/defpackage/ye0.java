...
public final class ye0 extends SuspendLambda implements Function2 {
    ...
    public ye0(uf0 uf0Var, String str, String str2, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new ye0(this.b, this.c, this.d, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                String str2 = this.d;
                this.a = 1;
                obj = apiService.hideFromResume(str, str2, true, this);
