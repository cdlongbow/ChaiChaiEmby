...
public final /* synthetic */ class gc1 implements Function2 {
    ...
    public final Object invoke(Object obj, Object obj2) {
        switch (this.a) {
            case 0:
                ...
                return OutlinedTextFieldKt.OutlinedTextField$lambda$8(this.b, this.c, this.d, this.e, this.g, this.h, this.i, this.j, this.k, this.l, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.v, this.w, this.x, this.y, this.z, this.A, this.B, this.C, (Composer) obj, iIntValue);
            default:
                int iIntValue2 = ((Integer) obj2).intValue();
                return TextFieldKt.TextField$lambda$8(this.b, this.c, this.d, this.e, this.g, this.h, this.i, this.j, this.k, this.l, this.m, this.n, this.o, this.p, this.q, this.r, this.s, this.t, this.u, this.v, this.w, this.x, this.y, this.z, this.A, this.B, this.C, (Composer) obj, iIntValue2);
        }
    }
}
