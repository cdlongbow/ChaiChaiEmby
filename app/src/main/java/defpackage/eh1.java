...
public final class eh1 implements Player.Listener {
    ...
    public final void onPlayerError(PlaybackException playbackException) {
        ...
        if (z3 && z4 && !z5 && z6 && z7) {
            ...
            lowerCase.getClass();
            if (StringsKt__lowerCase.contains("libass") || StringsKt__lowerCase.contains("asssubtitle") || StringsKt__lowerCase.contains("peerless2012")) {
        ...
        boolean z8 = StringsKt__message4.contains("VideoRenderer") || StringsKt__message4.contains("video/") || !((cause2 = playbackException.getCause()) == null || (string2 = cause2.toString()) == null || !StringsKt__string2.contains("Video"));
        boolean z9 = StringsKt__message4.contains("AudioRenderer") || StringsKt__message4.contains("audio/") || !((cause = playbackException.getCause()) == null || (string = cause.toString()) == null || !StringsKt__string.contains("Audio"));
        Context context = this.i;
        if (z8) {
                ...
                if (group4.getType() != 3) {
                    ...
                    while (i29 < i27) {
                        ...
                        if (group4.isTrackSupported(i29)) {
                            ...
                            String str42 = str38;
                            String str43 = str35;
                            boolean z27 = StringsKt__StringsKt.contains(str40, (CharSequence) "external", true) || StringsKt__lowerCase3.contains("外挂") || StringsKt__lowerCase3.contains("external");
                            ...
                            if (group4.isTrackSelected(i29)) {
                                if (StringsKt__StringsKt.contains(str40, (CharSequence) "pgs", true)) {
                                    ...
                                    if (!StringsKt__StringsKt.contains(str40, (CharSequence) "dvb", true)) {
                                        i4 = i29;
                                        z5 = Intrinsics.areEqual(str36, MimeTypes.APPLICATION_PGS) || Intrinsics.areEqual(str36, MimeTypes.APPLICATION_DVBSUBS) || StringsKt__str36.contains("pgs") || StringsKt__str36.contains("dvbsub") || StringsKt__str36.contains("dvb_subtitle") || StringsKt__lowerCase.contains("pgs") || StringsKt__lowerCase.contains("hdmv_pgs") || StringsKt__lowerCase.contains("dvb") || StringsKt__lowerCase5.contains("pgs") || StringsKt__lowerCase5.contains("dvb") || StringsKt__lowerCase4.contains("pgs") || StringsKt__lowerCase4.contains("hdmv_pgs") || StringsKt__lowerCase4.contains("dvb") || StringsKt__lowerCase3.contains("-pgs") || StringsKt__lowerCase3.contains("(pgs)") || StringsKt__lowerCase3.contains("-dvb") || StringsKt__lowerCase3.contains("(dvb)");
                                        if (!StringsKt__StringsKt.contains$default(str36, (CharSequence) str33, false, 2, (Object) null) || StringsKt__str36.contains("ssa") || StringsKt__StringsKt.contains$default(lowerCase, (CharSequence) str33, false, 2, (Object) null) || StringsKt__lowerCase.contains("ssa") || StringsKt__StringsKt.contains$default(lowerCase5, (CharSequence) str33, false, 2, (Object) null) || StringsKt__lowerCase5.contains("ssa") || StringsKt__StringsKt.contains$default(lowerCase4, (CharSequence) str33, false, 2, (Object) null) || StringsKt__lowerCase4.contains("ssa") || StringsKt__lowerCase3.contains("-ass") || StringsKt__lowerCase3.contains("(ass)") || StringsKt__lowerCase3.contains("-ssa") || StringsKt__lowerCase3.contains("(ssa)")) {
                                            z6 = true;
                                        } else {
                                            z6 = false;
                                        }
