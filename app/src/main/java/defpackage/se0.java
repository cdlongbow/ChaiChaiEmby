...
public final class se0 extends SuspendLambda implements Function2 {
    public int a;
    ...
    public se0(uf0 uf0Var, String str, String str2, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new se0(this.b, this.c, this.d, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((se0) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                String str2 = this.d;
                this.a = 1;
                obj = apiService.getSeasons(str, str2, "PrimaryImageAspectRatio", this);
            ...
            if (!response.isSuccessful() || response.body() == null) {
                ...
                objM8825constructorimpl = Result.m8825constructorimpl(ResultKt.createFailure(new Exception("获取季列表失败: " + response.message())));
            } else {
