...
public abstract class wd2 {
    ...
    public static final vd2 b = new vd2(0);
    public static final vd2 c = new vd2(1);
    public static final vd2 d = new vd2(2);
    public static final vd2 e = new vd2(3);
    ...
    public static void a(Path path, float f2, float f3, float f4) {
        ...
        if (!(f2 == 1.0f && f3 == 0.0f) && length >= 1.0f && Math.abs((f3 - f2) - 1.0f) >= 0.01d) {
            ...
            if (fMin >= length && fMax >= length) {
                fMin = s41.d(fMin, length);
                fMax = s41.d(fMax, length);
            }
            if (fMin < 0.0f) {
                fMin = s41.d(fMin, length);
            }
